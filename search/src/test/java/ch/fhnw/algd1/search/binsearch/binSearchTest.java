...
public class binSearchTest {
    ...
    public void testExistingIntegerAtStart() {
        ...
        int index = binSearch.binSearch(elements, 1);
    ...
    public void testExistingIntegerInBetween1() {
        int[] elements = new int[] { 1, 3, 4, 5, 9 };
        int index = binSearch.binSearch(elements, 3);
    ...
    public void testExistingIntegerInBetween2() {
        int[] elements = new int[] { 1, 3, 4, 5, 9 };
        int index = binSearch.binSearch(elements, 4);
    ...
    public void testExistingIntegerInBetween3() {
        int[] elements = new int[] { 1, 3, 4, 5, 9 };
        int index = binSearch.binSearch(elements, 5);
    ...
    public void testExistingIntegerAtEnd() {
        int[] elements = new int[] { 1, 3, 4, 5, 9 };
        int index = binSearch.binSearch(elements, 9);
    ...
    public void testNonExistingInteger() {
        int[] elements = new int[] { 1, 3, 4, 5, 9 };
        int index = binSearch.binSearch(elements, 7);
        assertEquals(-1, index);
    }
    ...
    public void testTooSmallInteger() {
        int[] elements = new int[] { 1, 3, 4, 5, 9 };
        int index = binSearch.binSearch(elements, 0);
        assertEquals(-1, index);
    }
    ...
    public void testTooLargeInteger() {
        int[] elements = new int[] { 1, 3, 4, 5, 9 };
        int index = binSearch.binSearch(elements, 11);
        assertEquals(-1, index);
    }
    ...
    public void testEqualInteger() {
        ...
        int index = binSearch.binSearch(elements, 6);
        assertEquals(-1, index);
    }
}
